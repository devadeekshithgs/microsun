...
// Hook for admin all orders (complete history)
export function useAllOrders() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (ordersError) {
        console.error('Failed to fetch all orders:', ordersError);
        throw ordersError;
      }
      ...
      console.log('All orders fetched with details:', data?.length || 0, 'orders');
      return data as unknown as Order[];
    },
    staleTime: 1000 * 30,
  });
...
export const useIncomingOrders = useAllOrders;
...
export function useCreateOrder() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      // Orders are created as 'confirmed' by default - no approval needed
